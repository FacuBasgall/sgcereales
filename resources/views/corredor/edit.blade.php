...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="box">
                <form action="{{action('CorredorController@update', $corredor->cuit)}}" method="POST" autocomplete="off">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    @if ($errors->any())
                    ...
                    <label for="nombre">
                        ...
                        <input type="text" name="nombre" id="nombre" class="common-input" value="{{$corredor->nombre}}"
                            maxlength="200" required>
                    </label>
                    <label for="cuit">
                        <span>CUIT: </span>
                        <input type="number" name="cuit" id="cuit" class="common-input @error('cuit') is-invalid @enderror" min="0" max="999999999999999" value="{{$corredor->cuit}}" required>
                    </label>
                    <label for="dgr">
                        <span>DGR: </span>
                        <input type="text" name="dgr" id="dgr" class="common-input" value="{{$corredor->dgr}}"
                            maxlength="20">
                    </label>
                    ...
                    <label for="domicilio">
                        ...
                        <input type="text" name="domicilio" id="domicilio" class="common-input-address"
                            value="{{$corredor->domicilio}}" maxlength="250">
                    </label>
                    <hr>
