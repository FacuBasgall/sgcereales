...
<body>
    <div class="card-header">
        <label class="title col-md-8 col-form-label"><a href="{{ action('CorredorController@index') }}">Corredores</a> <i
        ...
        <div class="card">
            <div class="box">
                <form action="{{action('CorredorController@update', $corredor->cuit)}}" method="POST">
                    ...
                    <label for="cuit">
                        <span>CUIT: </span>
                        <input type="text" name="cuit" id="cuit" class="common-input" value="{{$corredor->cuit}}"
                            readonly>
                    </label>
                    <label for="dgr">
                        <span>DGR: </span>
                    ...
                    <label for="cp" id="cod" style="display:;">
                        ...
                        <input type="text" name="cp" id="cp" class="common-input-cp" value="{{$corredor->cp}}">
                    </label>
