...
<body>
    <div class="card-header">
        <label class="title col-md-8 col-form-label"><a href="{{ action('CorredorController@index') }}">Corredores
    ...
    <div class="container">
        <div class="form-card">
            ...
            <form action="{{action('CorredorController@add_contact', $corredor->cuit)}}" method="GET" autocomplete="off">
                {{ csrf_field() }}
                <label for="tipo">
        ...
        <div class="contacts-card">
            ...
            <div class="flex-elements">
                ...
                <div class="margin-right"><strong>{{$tipo->descripcion}}: </strong>{{$contacto->contacto}} <a
                        onclick="warningContact('{{$contacto->id}}', 'corredor');"><button class="small-delete-button"
