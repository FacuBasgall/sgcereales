		...
		<div class="row" style="margin-top:-20px">
			<div class="container">
               ...
               <div class="box">
                     ...
                     <button type="submit" class="save-button" style="position:relative; top:70%; left:35%;"><i class="fa fa-check"></i></button>
                     <a href="{{ action('DestinoController@index') }}"><button type="button" class="delete-button" title="Cancelar" style="position: relative; top: 50%; right: 15%;"><i class="fa fa-close"></i></button></a>
                  </form>
               </div>
            </div>
         </div>
