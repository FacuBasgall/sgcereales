...
<body>
    <div class="card-header">
        <label class="title col-md-8 col-form-label"><a href="{{ action('DestinoController@index') }}">Destinatarios
            </a> <i class="fa fa-chevron-right"></i>
            <a href="{{ action('DestinoController@show', $destino->cuit) }}">Detalle del destinatario</a> <i
    ...
    <div class="container">
        <div class="form-card">
            ...
            <form action="{{action('DestinoController@add_contact', $destino->cuit)}}" method="GET" autocomplete="off">
                {{ csrf_field() }}
                <label for="tipo">
        ...
        <div class="contacts-card">
            ...
            <div class="flex-elements">
                ...
                <div class="margin-right"><strong>{{$tipo->descripcion}}: </strong>{{$contacto->contacto}} <a
                        onclick="warningContact('{{$contacto->id}}', 'destino');"><button class="small-delete-button"
