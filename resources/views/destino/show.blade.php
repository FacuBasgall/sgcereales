		...
		<div class="container">
			<div class="card">
                <div class="box">
                    ...
                    @endif
            <hr>
            <h4><strong>Infomación de contacto: </strong><a href="{{ action('DestinoController@contact', $destino->cuit) }}">Editar</a></h4>
            @if (!$contacto->isEmpty())
            ...
            <a onclick="warning( '{{$destino->cuit}}' , 'destino');"><button class="delete-button" title="Eliminar" style="position: relative; top: 10%; left: 20%;"><i class="fa fa-trash"></i></button></a>
