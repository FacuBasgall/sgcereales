	...
	<body style="background:url(/image/corredor.jpg) no-repeat center center fixed">
			<div class="container">
               ...
               <div class="box" style="margin-top: 20px">
                     ...
                     <a href="{{ action('IntermediarioController@show', $intermediario->cuit) }}"><button type="button" class="back-button" title="Volver" style="position: relative; top: 50%; right: 35%;"><i class="fa fa-arrow-left"></i></button></a>
                  </form>
               </div>
            </div>
         </div>
