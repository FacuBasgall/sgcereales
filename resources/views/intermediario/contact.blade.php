...
@section('content')
	...
	<body style="background-image:url(/image/corredor.jpg); no-repeat center center fixed">
			<div class="container">
               ...
               <form action="{{action('IntermediarioController@add_contact', $cuit)}}" method="GET">
                     {{ csrf_field() }}
                    ...
                    <a href="{{ action('IntermediarioController@show', $cuit)}}"><button  title="Salir" style="position: relative; top: 10%; left: 20%;">Salir</button></a>
               </div>
         </div>
      </div>
   </body>
