...
@section('content')
    ...
    <body style="background:url(/image/cargador-camion.jpg) no-repeat center center fixed">
		<div class="container">
            ...
            <a onclick="warning( '{{$cargador->cuit}}' , 'cargador');"><button class="delete-button" title="Eliminar" style="position: relative; top: 10%; left: 20%;"><i class="fa fa-trash"></i></button></a>
