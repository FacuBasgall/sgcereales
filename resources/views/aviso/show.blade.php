...
@section('content')
    ...
    <div class="card-header">
        <label class="title col-md-8 col-form-label"><b>Detalle del aviso</b></b></label>
    </div>
        ...
        @if (isset($aviso->observacion))
            <strong>Observacion : </strong>{{$aviso->observacion}}<br>
        @else
            <strong>Observacion : </strong>No ingresado<br>
        @endif
        <br><hr>
