...
@section('content')
    ...
    <body style="background:url(/image/intermediario.jpg) no-repeat center center fixed">
		<div class="container">
			<div class="card"> 
                <div class="box">
                    <div class="header">
            ...
            <a onclick="warning( '{{$intermediario->cuit}}' , 'intermediario');"><button class="delete-button" title="Eliminar" style="position: relative; top: 10%; left: 20%;"><i class="fa fa-trash"></i></button></a>
