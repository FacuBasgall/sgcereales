...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="box">
                <form action="{{action('RemitenteController@update', $remitente->cuit)}}" method="POST" autocomplete="off">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    @if ($errors->any())
                    ...
                    <label for="cuit">
                        <span>CUIT: </span>
                        <input type="number" name="cuit" id="cuit" class="common-input @error('cuit') is-invalid @enderror" min="0" max="999999999999999" value="{{$remitente->cuit}}" required>
                    </label>
                    <label for="dgr">
                        <span>DGR: </span>
                    ...
                    <label for="pais" class="margin-right">
                        ...
                        <select name="pais" id="pais" class="common-input" onChange="paisOnChange(this)">
                            ...
                            @elseif($remitente->pais != "Argentina" && $remitente->pais != NULL)
